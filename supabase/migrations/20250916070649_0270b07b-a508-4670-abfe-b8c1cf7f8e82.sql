...
DROP POLICY IF EXISTS "Agents can view related property images" ON storage.objects;
...
DROP POLICY IF EXISTS "Agents can view related property layouts" ON storage.objects;
...
DROP POLICY IF EXISTS "Agents can upload property layouts" ON storage.objects;
...
DROP POLICY IF EXISTS "Agents can update own property layouts" ON storage.objects;
...
DROP POLICY IF EXISTS "Agents can delete own property layouts" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can view related documents" ON storage.objects;
