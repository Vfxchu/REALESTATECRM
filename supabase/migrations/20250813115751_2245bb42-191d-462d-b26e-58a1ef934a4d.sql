...
-- 0. Ensure leads_per_agent_per_month exists (was created manually on old project, not via migrations)
CREATE TABLE IF NOT EXISTS public.leads_per_agent_per_month (
