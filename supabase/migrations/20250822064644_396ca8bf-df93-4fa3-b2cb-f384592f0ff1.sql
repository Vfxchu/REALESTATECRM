...
DROP POLICY IF EXISTS "Admin can view all analytics" ON public.leads_per_agent_per_month;
...
DROP POLICY IF EXISTS "Agent can view own analytics" ON public.leads_per_agent_per_month;
...
DROP POLICY IF EXISTS "No client modifications" ON public.leads_per_agent_per_month;
