...
DROP POLICY IF EXISTS "properties_select_secure" ON public.properties;
...
DROP POLICY IF EXISTS "leads_per_agent_stats_select" ON public.leads_per_agent_per_month;
