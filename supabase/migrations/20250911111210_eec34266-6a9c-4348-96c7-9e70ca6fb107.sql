...
DROP POLICY IF EXISTS "Agents can create contact files for their leads" ON contact_files;
DROP POLICY IF EXISTS "Agents can view contact files for their leads" ON contact_files;
DROP POLICY IF EXISTS "Agents can update contact files for their leads" ON contact_files;
DROP POLICY IF EXISTS "Agents can delete contact files for their leads" ON contact_files;
DROP POLICY IF EXISTS "Agents can create property files for their properties" ON property_files;
DROP POLICY IF EXISTS "Agents can view property files for their properties" ON property_files;
DROP POLICY IF EXISTS "Agents can update property files for their properties" ON property_files;
DROP POLICY IF EXISTS "Agents can delete property files for their properties" ON property_files;
DROP POLICY IF EXISTS "Profiles created by trigger only" ON profiles;
...
DROP POLICY IF EXISTS "Agents can create leads assigned to themselves" ON leads;
