...
-- Add created_by column early to prevent policy creation failures (due to out-of-order migrations)
ALTER TABLE public.property_files ADD COLUMN IF NOT EXISTS created_by uuid REFERENCES auth.users(id) ON DELETE SET NULL;
